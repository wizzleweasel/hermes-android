...
[![Stars](https://img.shields.io/github/stars/wizzleweasel/hermes-android?style=for-the-badge&color=ffd93d)](https://github.com/AbuZar-Ansarii/Hermes-Agent-On-Android)
...
```bash
curl -fsSL https://raw.githubusercontent.com/wizzleweasel/hermes-android/main/nous_agent.sh | bash
```
...
git clone https://github.com/wizzleweasel/hermes-android.git
cd hermes-android
